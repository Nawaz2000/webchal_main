...
const Nav: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 h-12 py-2 md:py-0 md:h-20 flex items-center justify-center box-border px-2 md:px-5 lg:px-16 flex-row-reverse md:flex-row shadow-md md:shadow-none bg-white z-30">
